...
function About() {
  return (
    <div className="p-5 sm:p-14 lg:p-20 lg:py-10 w-full">
      <div className="flex flex-col items-center justify-center gap-1 w-full md:w-1/2 mx-auto">
        <p className="text-gray-800">Who Are We</p>
